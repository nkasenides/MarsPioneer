...
@WebServlet(name = "AuthenticateServlet", urlPatterns = {"/api/auth"})
public class AuthenticateServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.authenticate(buffer.toByteArray(), additionalParameters).toByteArray();
    }
