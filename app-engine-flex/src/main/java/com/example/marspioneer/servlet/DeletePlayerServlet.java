...
@WebServlet(name = "DeletePlayerServlet", urlPatterns = {"/api/player/delete"})
public class DeletePlayerServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.deletePlayer(buffer.toByteArray(), additionalParameters).toByteArray();
    }
