...
@WebServlet(name = "DeleteWorldServlet", urlPatterns = {"/api/world/delete"})
public class DeleteWorldServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.deleteWorld(buffer.toByteArray(), additionalParameters).toByteArray();
    }
