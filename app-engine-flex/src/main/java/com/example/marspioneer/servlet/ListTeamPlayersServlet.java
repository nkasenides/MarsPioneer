...
@WebServlet(name = "ListTeamPlayersServlet", urlPatterns = {"api/team/listPlayers"})
public class ListTeamPlayersServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.listTeamPlayers(buffer.toByteArray(), additionalParameters).toByteArray();
    }
