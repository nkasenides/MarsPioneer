...
@WebServlet(name = "GetPlayerServlet", urlPatterns = {"/api/player/get"})
public class GetPlayerServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.getPlayer(buffer.toByteArray(), additionalParameters).toByteArray();
    }
