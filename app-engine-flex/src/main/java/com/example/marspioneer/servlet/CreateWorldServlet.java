...
@WebServlet(name = "CreateWorldServlet", urlPatterns = {"/api/world/create"})
public class CreateWorldServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.createWorld(buffer.toByteArray(), additionalParameters).toByteArray();
    }
