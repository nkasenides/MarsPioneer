...
@WebServlet(name = "UpdateWorldServlet", urlPatterns = {"/api/world/update"})
public class UpdateWorldServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.updateWorld(buffer.toByteArray(), additionalParameters).toByteArray();
    }
