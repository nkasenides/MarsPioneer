...
@WebServlet(name = "GetTeamServlet", urlPatterns = {"/api/team/get"})
public class GetTeamServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.getTeam(buffer.toByteArray(), additionalParameters).toByteArray();
    }
