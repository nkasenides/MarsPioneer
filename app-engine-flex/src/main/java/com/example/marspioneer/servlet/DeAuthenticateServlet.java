...
@WebServlet(name = "DeAuthenticateServlet", urlPatterns = {"/api/deauth"})
public class DeAuthenticateServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.deAuthenticate(buffer.toByteArray(), additionalParameters).toByteArray();
    }
