...
@WebServlet(name = "LeaveWorldServlet", urlPatterns = {"/api/world/leave"})
public class LeaveWorldServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.leaveWorld(buffer.toByteArray(), additionalParameters).toByteArray();
    }
