...
@WebServlet(name = "UpdateTeamServlet", urlPatterns = {"/api/team/update"})
public class UpdateTeamServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.updateTeam(buffer.toByteArray(), additionalParameters).toByteArray();
    }
