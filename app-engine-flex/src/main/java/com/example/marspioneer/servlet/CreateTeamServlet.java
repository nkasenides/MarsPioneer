...
@WebServlet(name = "CreateTeamServlet", urlPatterns = {"/api/team/create"})
public class CreateTeamServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.createTeam(buffer.toByteArray(), additionalParameters).toByteArray();
    }
