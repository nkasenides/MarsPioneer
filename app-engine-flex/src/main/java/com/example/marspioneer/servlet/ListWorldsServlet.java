...
@WebServlet(name = "ListWorldsServlet", urlPatterns = {"/api/world/list"})
public class ListWorldsServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.listWorlds(buffer.toByteArray(), additionalParameters).toByteArray();
    }
