...
@WebServlet(name = "JoinWorldServlet", urlPatterns = {"/api/world/join"})
public class JoinWorldServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.joinWorld(buffer.toByteArray(), additionalParameters).toByteArray();
    }
