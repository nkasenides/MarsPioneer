...
@WebServlet(name = "AddPlayerToTeamServlet", urlPatterns = {"/api/team/addPlayer"})
public class AddPlayerToTeamServlet extends AthlosServlet {
    ...
    protected byte[] callProcessMethod(HttpServletRequest servletRequest, HttpServletResponse servletResponse, DataInputStream inputStream) throws ServiceNotFoundException, IOException {
        ...
        return Services.addPlayerToTeam(buffer.toByteArray(), additionalParameters).toByteArray();
    }
