...
public class MPWorld implements Transmittable<MPWorldProto.Builder>, IGrid4World, Serializable {
    ...
    public final boolean chunkIsInBounds(int chunkRow, int chunkCol) {
        final int startRow = MPTerrainChunk.getChunkStartRowFromChunkRow(chunkRow);
        final int lastRow = MPTerrainChunk.getChunkLastRowFromChunkRow(chunkRow);
        final int startCol = MPTerrainChunk.getChunkStartColFromChunkCol(chunkCol);
        final int lastCol = MPTerrainChunk.getChunkLastColFromChunkCol(chunkCol);
