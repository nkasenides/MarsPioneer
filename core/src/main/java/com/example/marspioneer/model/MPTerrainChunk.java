...
public class MPTerrainChunk implements Transmittable<MPTerrainChunkProto.Builder>, ITerrainChunk {
    ...
    public void setCells(HashMap<String, MPTerrainCell> cells) {
        this.cells = cells;        
    }    
    ...
    @Override    
    public com.example.marspioneer.proto.MPTerrainChunkProto.Builder toProto() {    
        com.example.marspioneer.proto.MPTerrainChunkProto.Builder protoBuilder = com.example.marspioneer.proto.MPTerrainChunkProto.newBuilder();        
        HashMap<String,com.example.marspioneer.proto.MPTerrainCellProto> cellsMap = new HashMap<>();        
        for (java.util.Map.Entry<String,com.example.marspioneer.model.MPTerrainCell> entry : cells.entrySet()) {        
    ...
    public static int getChunkRow(int cellRow) {
        if (cellRow % MPTerrainChunk.SIZE != 0) {
            return cellRow / MPTerrainChunk.SIZE + getRowOffset(cellRow);
        }
        return cellRow / MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkCol(int cellCol) {
        if (cellCol % MPTerrainChunk.SIZE != 0) {
            return cellCol / MPTerrainChunk.SIZE + getColOffset(cellCol);
        }
        return cellCol / MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkStartRow(int cellRow) {
        return getChunkRow(cellRow) * MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkStartRowFromChunkRow(int chunkRow) {
        return chunkRow * MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkLastRow(int cellRow) {
        return getChunkStartRow(cellRow) + MPTerrainChunk.SIZE - 1;
    }
    ...
    public static int getChunkLastRowFromChunkRow(int chunkRow) {
        return chunkRow * MPTerrainChunk.SIZE + MPTerrainChunk.SIZE - 1;
    }
    ...
    public static int getChunkStartCol(int cellCol) {
        return getChunkCol(cellCol) * MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkStartColFromChunkCol(int chunkCol) {
        return chunkCol * MPTerrainChunk.SIZE;
    }
    ...
    public static int getChunkLastCol(int cellCol) {
        return getChunkStartCol(cellCol) + MPTerrainChunk.SIZE - 1;
    }
    ...
    public static int getChunkLastColFromChunkCol(int chunkCol) {
        return chunkCol * MPTerrainChunk.SIZE + MPTerrainChunk.SIZE - 1;
    }
