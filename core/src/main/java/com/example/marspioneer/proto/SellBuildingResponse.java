...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return MarsPioneerProto.internal_static_com_example_marspioneer_proto_SellBuildingResponse_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return MarsPioneerProto.internal_static_com_example_marspioneer_proto_SellBuildingResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            SellBuildingResponse.class, Builder.class);
  }
  ...
  public enum Status
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return SellBuildingResponse.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (status_ != Status.CANNOT_SELL.getNumber()) {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof SellBuildingResponse)) {
      return super.equals(obj);
    }
    SellBuildingResponse other = (SellBuildingResponse) obj;
  ...
  public static SellBuildingResponse parseFrom(
  ...
  public static SellBuildingResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SellBuildingResponse parseFrom(
  ...
  public static SellBuildingResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SellBuildingResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static SellBuildingResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SellBuildingResponse prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public SellBuildingResponse getDefaultInstanceForType() {
      return SellBuildingResponse.getDefaultInstance();
    }

    @Override
    public SellBuildingResponse build() {
      SellBuildingResponse result = buildPartial();
    ...
    @Override
    public SellBuildingResponse buildPartial() {
      SellBuildingResponse result = new SellBuildingResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SellBuildingResponse) {
        return mergeFrom((SellBuildingResponse)other);
      } else {
    ...
    public Builder mergeFrom(SellBuildingResponse other) {
      if (other == SellBuildingResponse.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      SellBuildingResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (SellBuildingResponse) e.getUnfinishedMessage();
  ...
  private static final SellBuildingResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SellBuildingResponse();
  }

  public static SellBuildingResponse getDefaultInstance() {
