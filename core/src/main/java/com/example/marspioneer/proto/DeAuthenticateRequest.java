...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return MarsPioneerProto.internal_static_com_example_marspioneer_proto_DeAuthenticateRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return MarsPioneerProto.internal_static_com_example_marspioneer_proto_DeAuthenticateRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            DeAuthenticateRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof DeAuthenticateRequest)) {
      return super.equals(obj);
    }
    DeAuthenticateRequest other = (DeAuthenticateRequest) obj;
  ...
  public static DeAuthenticateRequest parseFrom(
  ...
  public static DeAuthenticateRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static DeAuthenticateRequest parseFrom(
  ...
  public static DeAuthenticateRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static DeAuthenticateRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static DeAuthenticateRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(DeAuthenticateRequest prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public DeAuthenticateRequest getDefaultInstanceForType() {
      return DeAuthenticateRequest.getDefaultInstance();
    }

    @Override
    public DeAuthenticateRequest build() {
      DeAuthenticateRequest result = buildPartial();
    ...
    @Override
    public DeAuthenticateRequest buildPartial() {
      DeAuthenticateRequest result = new DeAuthenticateRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof DeAuthenticateRequest) {
        return mergeFrom((DeAuthenticateRequest)other);
      } else {
    ...
    public Builder mergeFrom(DeAuthenticateRequest other) {
      if (other == DeAuthenticateRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      DeAuthenticateRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (DeAuthenticateRequest) e.getUnfinishedMessage();
  ...
  private static final DeAuthenticateRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DeAuthenticateRequest();
  }

  public static DeAuthenticateRequest getDefaultInstance() {
